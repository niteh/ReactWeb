   ...
   <NavLink className="navbar-brand" to="/">React Template</NavLink>
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav mr-auto mb-2 mb-lg-0 ">
        ...
        <li className="nav-item">
         <NavLink  activeClassName ="menu-active"    className="nav-link" to="/covid">API Data</NavLink>
        </li>

        <li className="nav-item">
         <NavLink  activeClassName ="menu-active"    className="nav-link" to="/table">Data Table</NavLink>
        </li>
      </ul>
